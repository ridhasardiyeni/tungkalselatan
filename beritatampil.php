...
<head>
    ...
    <title>Berita Masyarakat Desa Tungkal Selatan</title>
				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Berita Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							...
							$ambil_data= mysql_query("SELECT * FROM berita where id = ".$id_berita."  limit 0,1");							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									echo "<h3><center>".$data['judul']."</h3></center>";
									echo "<center><img src='admin/images_berita/" . $data['foto'] . "' width='350' height='120'></center>";
