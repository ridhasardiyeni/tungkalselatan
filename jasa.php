...
<head>
    ...
    <title>Jasa Masyarakat Desa Tungkal Selatan</title>
				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Jasa Masyarakat Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							...
							$ambil_data= mysql_query("SELECT * FROM jasa_masyarakat order by id desc limit 3");							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									$id_jasa = $data['id'];
									echo "<div class= 'col-md-4'>";
									echo "<img src='admin/images_jasa_masyarakat/" . $data['foto'] . "' width='250' height='100'>";
									echo "<h3>".$data['judul']."</h3>";
									echo $data=substr($data['keterangan'],0,110);
									?>
									<br><a href="jasatampil.php?id_jasa=<?php echo $id_jasa; ?>">Selengkapnya...</a>
									</div>
									<?php						 
 								}
							?>
