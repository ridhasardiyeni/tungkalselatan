...
<head>
    ...
    <title>Desa Tungkal Selatan</title>
...
<header>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<ul class="list-inline top-link link">
						<li><a href="admin/index.php"><i class="fa fa-user fa-fw"></i> Login </a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="slider/a1.jpg" alt="First slide">
							<!-- Static Header -->
							<div class="header-text hidden-xs">
							</div><!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a2.jpg" alt="Second slide">
							<!-- Static Header -->
							<div class="header-text hidden-xs">
						...
						<div class="item">
							<img src="slider/a3.jpg" alt="Third slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a4.jpg" alt="Third slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a5.jpg" alt="Third slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a6.jpg" alt="Four slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a7.jpg" alt="Five slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a8.jpg" alt="Six slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a9.jpg" alt="Third slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
						<div class="item">
							<img src="slider/a11.jpg" alt="Seven slide">
							<!-- Static Header -->
							<!-- /header-text -->
						</div>
					</div>
				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Berita Masyarakat</h2>

						</div>
						<div class="box-content">
							<?php 
							include "admin/koneksi.php";							 
							$ambil_data= mysql_query("SELECT * FROM berita order by id desc ");							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									$id_berita = $data['id'];
									echo "<div class= 'col-md-4'>";
									echo "<img src='admin/images_berita/" . $data['foto'] . "' width='250' height='100'>";
									echo "<h3>".$data['judul']."</h3>";
									echo $data=substr($data['keterangan'],0,110);
									?>
									<br><a href="beritatampil.php?id_berita=<?php echo $id_berita; ?>">Selengkapnya...</a>
									</div>
									<?php
 								}
							?>
					...
					<div class="box">
						...
						<div class="box-content">
							...
							$ambil_data= mysql_query("SELECT * FROM produk order by id desc limit 2");							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									$id_produk = $data['id'];
									echo "<div class= 'col-md-6'>";
									echo "<img src='admin/images_produk/" . $data['foto'] . "' width='250' height='100'>";
									echo "<h3>".$data['judul']."</h3>";
									echo $data=substr($data['keterangan'],0,110);
									?>
									<br><a href="produktampil.php?id_produk=<?php echo $id_produk; ?>">Selengkapnya...</a>
									</div>
									<?php						 
 								}
							?>
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Galeri Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							<div class="row">
								<div class="row">
							...
							<?php 
							include "admin/koneksi.php";							 
							$ambil_data= mysql_query("SELECT * FROM galeri");							 
								while($data=mysql_fetch_array($ambil_data))	
								{		
										echo "<div class='item'>";
										echo "&nbsp&nbsp<img src='admin/images/" . $data['foto']. "' width='280' height='100'></td></div>";
					...
					<div class="widget wid-vid">
						...
						<div class="zoom-container">
											...
											<?php 
												...
												while($data=mysql_fetch_array($ambil_data))	
												{			 
													echo "<td><img src='admin/images_aparatur/" . $data['foto'] . "' width='250' height='200'></td>";					 
 												}
											?>
											</div>
										</div>
	...
	<footer>
		<div class="copy-right">
			<p>Copyright 2018 - Designed by <a href="#">Muslim Technology</a></p>
		</div>
	</footer>
	<!-- Footer -->
