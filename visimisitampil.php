...
<head>
    ...
    <title> Visi dan Misi Desa Tungkal Selatan</title>
				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Visi dan Misi Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							<div class="row">
							<?php 
							include "admin/koneksi.php";							 
							$ambil_data= mysql_query("SELECT * FROM visimisi");							 
