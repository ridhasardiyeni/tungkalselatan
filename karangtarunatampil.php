...
<head>
    ...
    <title> Karang Taruna Desa Tungkal Selatan</title>
				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Karang Taruna Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							<div class="row">
							<?php 
							include "admin/koneksi.php";							 
							$ambil_data= mysql_query("SELECT * FROM karangtaruna");							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
										echo "<img src='admin/images_karangtaruna/" . $data['foto'] . "' width='1000' height='400'></td>";				 
 								}
							?>
							</div>
						</div>
