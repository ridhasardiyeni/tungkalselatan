...
if ($_GET['aksi'] == 'input') {
    ...
    $path = "images_produk/" . $fotobaru;
    if ($judul != null and $keterangan != null and  $foto != null) {
        if (move_uploaded_file($tmp, $path)) {
            $sql_input = "INSERT INTO `produk` (`id`, `judul`, keterangan, `foto`) VALUES "
    ...
    if ($foto != null) {
        ...
        if ($judul != null and  $keterangan != null) {
            if (move_uploaded_file($tmp, $path)) {
                ...
                if (is_file("images_produk/" . $ambil_foto['foto'])) {
                    unlink("images_produk/" . $ambil_foto['foto']);
                }
                $sql_edit = "UPDATE produk SET judul = '$judul',keterangan='$keterangan',foto='$fotobaru' WHERE id = '$id' ";
        ...
        if ($judul != null  and $keterangan != null) {
            $sql_edit = "UPDATE produk SET judul = '$judul',keterangan='$keterangan' WHERE id = '$id' ";
                $edit = mysql_query($sql_edit);
            if ($edit) {
                header("location:index.php?page=produk");
            } else {
    ...
    $sql_hapus = "DELETE FROM produk WHERE id = '$_GET[id]'";
