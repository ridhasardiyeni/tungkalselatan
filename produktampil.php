				...
				<div class="col-md-9">
					...
					<div class="box">
						<div class="box-header header-vimeo">
							<h2>Produk Desa Tungkal Selatan</h2>
						</div>
						<div class="box-content">
							...
							$ambil_data= mysql_query("SELECT * FROM produk WHERE id = ". $id_produk);							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									
									echo "<h3><center>".$data['judul']."</h3></center>";
									echo "<center><img src='admin/images_produk/" . $data['foto'] . "' width='350' height='120'></center>";
