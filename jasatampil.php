				...
				<div class="col-md-9">
					...
					<div class="box">
						...
						<div class="box-content">
							...
							$ambil_data= mysql_query("SELECT * FROM jasa_masyarakat WHERE id = ". $id_jasa);							 
								while($data=mysql_fetch_array($ambil_data))	
								{			 
									
									echo "<h3><center>".$data['judul']."</h3></center>";
									echo "<center><img src='admin/images_jasa_masyarakat/" . $data['foto'] . "' width='350' height='120'></center>";
